...
const env = {
  ...
  CORS_ORIGIN: process.env.CORS_ORIGIN || "https://linksmartbahamas.com,https://www.linksmartbahamas.com,http://localhost:3000,http://localhost:3001",
  ...
  AUTH_DEFAULT_REDIRECT_URL: process.env.AUTH_DEFAULT_REDIRECT_URL || "https://linksmartbahamas.com/auth/callback",
  AUTH_VERIFY_REDIRECT_URL: process.env.AUTH_VERIFY_REDIRECT_URL || "https://linksmartbahamas.com/results?verified=true",
